...
const famous_person = ` Allama iqbal once said, "Sajda-e-ishq ho to ibaadat mai maza ata hai 
khalli sajdon mai to duniya hi basa karti hai."`;
console.log(famous_person);
//05_Famous Quote 2: Repeat Exercise 4, but this time store the famous person’s name in a variable called famous_person. Then compose your message and store it in a new variable called message. Print your message.
const KHR = "KHADIM HUSSAIN RIZVI";
